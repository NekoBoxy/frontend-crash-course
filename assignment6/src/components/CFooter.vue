<template>
  <div class="footer">
    <div class="container mt-5">
      <div class="row">
        <div class="col-6 mt-5" style="display: flex; flex-wrap: wrap;">
          ...
          <div style="margin-left: 10px; margin-top: 10px;">
            <span
              style="display: block; font-size: 16px; color: #9086CC; font-weight: bold; margin-left: 5px;">Taiwan</span>
            <span style="font-size: 36px;">島遊</span>
          </div>
        </div>
