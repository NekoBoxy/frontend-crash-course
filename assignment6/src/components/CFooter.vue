<template>
  <div class="footer">
    <div class="container mt-5">
      <div class="row">
        <div class="col-6 mt-5 footer-logo">
          ...
          <div>
            <span class="footer-logo-en">Taiwan</span>
            <span class="footer-logo-zhtw">島遊</span>
          </div>
        </div>
      ...
      <div class="mt-5 copyright">
        <span>
          ...
          </svg>2023 Made by CatBoxy
          <a href="https://github.com/NekoBoxy" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-github mx-1" width="18" height="18" fill="currentColor"
              viewBox="0 0 16 16">
              <path
