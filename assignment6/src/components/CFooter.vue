      ...
      <div class="mt-5 copyright">
        <span>
          ...
          <a href="https://github.com/NekoBoxy" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-github ml-2" width="18" height="18" fill="currentColor"
              viewBox="0 0 16 16">
              <path
        ...
        <span>Source from 2021 F2E
          <a href="https://2021.thef2e.com/news/week1/" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-link"
              viewBox="0 0 16 16">
              <path
