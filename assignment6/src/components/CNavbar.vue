    ...
    <div class="container-fluid">
      <a class="navbar-brand" href="/" style="display: flex; flex-wrap: wrap;">
        ...
        <div style="margin-left: 10px;">
          <span style="display:block; font-size: 9px; color: #9086CC;">Taiwan</span>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <RouterLink to="/point" class="nav-link" aria-current="page">旅遊景點</RouterLink>
          </li>
          <li class="nav-item">
            <RouterLink to="/food" class="nav-link" aria-current="page">美食餐廳</RouterLink>
          </li>
        </ul>
        <form class="d-flex">
