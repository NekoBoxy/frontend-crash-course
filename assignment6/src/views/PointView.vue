  ...
  <main>
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-6">
          <!-- 標籤 -->
          <span class="badge rounded-pill bg-success text-white">{{ targetSpot.Class1 }}</span>
          <span class="badge rounded-pill bg-success text-white" style="margin-left: 5px; margin-right: 5px;">
            {{ targetSpot.Level }}
          </span>
          <h5>{{ targetSpot.ScenicSpotName }}</h5>
          <div><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div><svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div><svg width="20" height="24" viewBox="0 0 20 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
